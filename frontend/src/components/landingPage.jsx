    ...
    <Container maxWidth="lg" sx={{ marginTop: "74px" }}>
      <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
        ...
        >
          ...
          <p
            style={{ marginTop: "26px", marginBottom: "30px", maxWidth: "80%" }}
          >
            Compare fares from top ride-hailing services and choose the best
            deal. Save time, save money, ride smarter!
          </p>
